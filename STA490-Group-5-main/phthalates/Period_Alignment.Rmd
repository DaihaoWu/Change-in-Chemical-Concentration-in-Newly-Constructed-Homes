...
full_data_Matched_Period <- full_data_Matched_Period %>%
  mutate(
    # Calculate the total count of new furniture, ignoring NA values
    new_furniture_count = case_when(
      rowSums(is.na(select(., n_kmat_new, n_mat_cover_new, n_tmat_new, n_uph_chair_new, n_uph_sofa_new, n_uph_ottoman_new, n_uph_kids_new, n_uph_other_new, n_comp_dining_new, n_comp_bed_new, n_comp_dresser_new, n_comp_desk_new, n_comp_accent_new, n_comp_other_new))) == length(select(., n_kmat_new, n_mat_cover_new, n_tmat_new, n_uph_chair_new, n_uph_sofa_new, n_uph_ottoman_new, n_uph_kids_new, n_uph_other_new, n_comp_dining_new, n_comp_bed_new, n_comp_dresser_new, n_comp_desk_new, n_comp_accent_new, n_comp_other_new)) ~ NA_real_,
      TRUE ~ rowSums(select(., n_kmat_new, n_mat_cover_new, n_tmat_new, n_uph_chair_new, n_uph_sofa_new, n_uph_ottoman_new, n_uph_kids_new, n_uph_other_new, n_comp_dining_new, n_comp_bed_new, n_comp_dresser_new, n_comp_desk_new, n_comp_accent_new, n_comp_other_new), na.rm = TRUE)
    )
  )
...
full_data_Matched_Period <- full_data_Matched_Period %>% 
  mutate(morethan3_new_furniture = case_when(
    ...
    new_furniture_count < 3 ~ 0, 
    is.na(new_furniture_count) ~ NA_real_,
    TRUE ~ NA_real_
  ))
